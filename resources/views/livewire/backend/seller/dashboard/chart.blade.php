...
new class extends Component {
    ...
    public function loadDeletedPost(){
        return Product::where('created_by', $this->user_id)->where('status', 'DELETED')->count();
    }

    public function loadTransactionClosedPost(){
        return Product::where('created_by', $this->user_id)->where('qty', 0)->count();
    }

    public function loadTotalPost(){
        return Product::where('created_by', $this->user_id)->count();
    }

    public function loadMonthlyPost(){
        return Product::where('created_by', $this->user_id)
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white border border-gray-200 px-6 py-4 rounded-lg shadow-md flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-md text-gray-400">{{ $active_post }}</p>
                    </div>
                ...
                py-4 rounded-lg shadow-md flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-md text-gray-400">{{ $transaction_closed }}</p>
                    </div>
                ...
                <div class="bg-white border border-gray-200 px-6 py-4 rounded-lg shadow-md flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-md text-gray-400">{{ $deleted_post }}</p>
                    </div>
                ...
                <div class="bg-white border border-gray-200 px-6 py-4 rounded-lg shadow-md flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-md text-gray-400">{{ $total_post }}</p>
                    </div>
