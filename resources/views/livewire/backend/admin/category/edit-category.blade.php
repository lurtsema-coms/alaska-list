...
new class extends Component {
    ...
    function mount($category){
        ...
        $this->category_products = $category->products->toArray();
            ...
            @click.outside="edit_category_modal=false; $wire.resetSubCategory(); $wire.resetEditValidation()">
                <div class="p-10 max-h-[35rem] overflow-auto">
                    <form wire:submit="saveCategory">
                        <p class="mb-6 text-lg font-bold tracking-wide pointer-events-none text-slate-700">Edit Category</p>
                        <div class="space-y-4">
                            <div class="space-y-2">
                            ...
                            <button type="button" wire:click="addSubCategory">
                                <div class="inline-block p-2 border border-orange-400 rounded-full cursor-pointer hover:bg-orange-400">
                            ...
                            <div>
                                <p class="mb-2 text-gray-600">Sub Categories Added</p>
