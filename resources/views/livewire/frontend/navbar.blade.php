        ...
        <div class="container mx-auto py-2 px-2 sm:px-0">
            <div class="flex justify-between items-center">
                ...
                <div class="flex justify-end items-center gap-4 w-full">
                    ...
                    <a class="hidden text-slate-600 font-medium hover:text-slate-800 lg:block" href="/register" wire:navigate>Register</a>
                    <a class="hidden text-slate-600 font-medium hover:text-slate-800 lg:block" href="/login" wire:navigate>Login</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="flex flex-col gap-5 text-white">
            ...
            <div class="flex flex-col gap-5 mt-10 lg:hidden">
                <a class="relative group px-1" href="/register" wire:navigate>
                    <span class="transition-opacity group-hover:opacity-70">Register</span>
                    <span class="absolute -bottom-3 left-0 w-0 transition-all h-1 bg-white group-hover:w-full"></span>
                </a>
