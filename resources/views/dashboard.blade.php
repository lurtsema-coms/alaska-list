<x-app-layout>
    ...
    <div class="py-12">
        <div class="container py-8 px-4 bg-white shadow sm:rounded-lg mx-auto space-y-8 sm:px-6 lg:px-8">
            <div class="gap-2 w-full max-w-[56.25rem] space-y-8">
                <div class="flex flex-wrap gap-8">
                    <div class="flex justify-between items-center bg-white border border-gray-200 px-10 py-5 shadow-sm rounded-2xl" style="flex: 1 0 250px;">
                        <div class="mr-3">
