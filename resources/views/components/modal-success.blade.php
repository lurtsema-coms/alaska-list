<div x-data="{ successModalOpen: $wire.entangle('successModalOpen') }"
    ...
    <template x-teleport="body">
        <div x-show="successModalOpen" class="fixed top-0 left-0 z-[99] flex items-center justify-center w-screen h-screen" x-cloak>
            ...
            <div x-show="successModalOpen"
                ...
                <div class="relative w-auto text-center">
                    <div class="flex flex-col items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="text-green-600 size-24">
