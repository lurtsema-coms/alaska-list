...
<body class="min-h-screen bg-[] font-sans text-slate-800 antialiased">
    <div class="flex flex-col h-full w-full">
            ...
            <div class="container mx-auto px-5 md:px-0">
                ...
                <div class="container mx-auto" data-aos="zoom-in">
                    <div class="max-w-7xl mx-auto flex flex-col gap-16 items-center px-10 py-16 bg-white rounded-xl shadow-md overflow-hidden md:px-20">
                        ...
                        <button class="text-white bg-[#2171a7] text-sm px-6 py-3 rounded-lg shadow-md hover:bg-[#2171a7bb] transition-colors duration-300 cursor-pointer">
                            Upload Now
                        </button>
                    </div>
                </div>
        ...
        {{-- Get In Touch --}}
        <div id="get-in-touch" class="mt-14 container mx-auto">
            <div class="mb-16 flex flex-col items-center gap-2" data-aos="zoom-in">
                ...
                <div class="mx-auto container px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="py-12 flex flex-wrap justify-between items-center flex-col gap-8 lg:flex-row">
                        ...
                        <ul class="text-md text-center sm:flex flex-wrap items-center justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500">
                            ...
                            <li><a href="#"  class="text-white hover:text-gray-400">Get In Touch</a></li>
                            <li><a href="#"  class="text-white hover:text-gray-400">Advertise with us</a></li>
                        </ul>
