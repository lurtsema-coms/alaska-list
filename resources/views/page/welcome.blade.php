    ...
    <div class="relative min-h-[42rem] w-full sm:container mx-auto  md:rounded-2xl">
        <div class="min-h-[38rem] flex md:p-10">
            <div class="w-full flex justify-center flex-col gap-8 text-white z-10 px-5 md:px-10 xl:w-1/2">
                <div>
                    <p class="text-2xl font-bold font-darkerGrotesque md:text-6xl">ANYTHING YOU NEED, WE'VE GOT YOU COVERED</p>
                    <p class="text-2xl font-bold font-darkerGrotesque md:text-6xl"></p>
                </div>
...
<div class="mt-28 relative py-28 bg-[#e0f2f1]" data-aos="zoom-in">
    <div class="sm:container mx-auto text-center px-5 md:px-24">
        <div class="relative inline-block">
            <h2 class="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#1e8a91] to-[#1b7c85] drop-shadow-lg">
                Lorem, ipsum dolor.
            </h2>
            <svg class="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-4" width="100%" height="60" viewBox="0 0 100 60" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0 30L50 0L100 30L50 60L0 30Z" fill="rgba(27, 124, 133, 0.1)" />
            </svg>
        </div>
        <p class="mt-4 text-lg text-slate-600 leading-relaxed max-w-4xl mx-auto">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam, aperiam.
        </p>
    </div>
</div>
